class Config:
    ...
    def getActivationPhrase():
        return "hey Joe"

    def getMusicFolder():
        return "/home/ranaldross/Music"
        #return "/run/media/ranaldross/Windows/Users/Ranald Ross/Music"
    ...
    def getAcceptedFiletypes():
        return ['.mp3','.wma','.mp4']

    def getYoutubePlaylistUrl(playListName):
        return playlistUrls

    def getPlaguiesSpeech():
